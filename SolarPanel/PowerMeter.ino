...
char auth[] = "oyJcXU8cK82faPOxNTKxRBiBOdAhVIDH";

// Your WiFi credentials.
// Set password to "" for open networks.
char ssid1[] = "MaryPro_mts";
char pass1[] = "hanna@ha?9605";

char ssid[] = "ScienceSoft-Guest";
char pass[] = "1slANdTh0Rr0p3END";
...
void setup()
{
  ...
  Blynk.config(auth, "synoblynk.hopto.org", 8080);
  Blynk.connect();
